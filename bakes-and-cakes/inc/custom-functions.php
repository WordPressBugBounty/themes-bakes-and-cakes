...
/**
 * Admin notice for dashboard page
*/
function bakes_and_cakes_admin_notice(){
    ...
    $dismissnonce   = wp_create_nonce( 'bakes_and_cakes_admin_notice' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><a href="<?php echo esc_url( admin_url( 'themes.php?page=bakes-and-cakes-dashboard' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Go to the Dashboard.', 'bakes-and-cakes' ); ?></a></p>
                    <p class="dismiss-link"><strong><a href="?bakes_and_cakes_admin_notice=1&_wpnonce=<?php echo esc_attr( $dismissnonce ); ?>"><?php esc_html_e( 'Dismiss', 'bakes-and-cakes' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function bakes_and_cakes_update_admin_notice(){
    ...
    if ( isset( $_GET['bakes_and_cakes_admin_notice'] ) && $_GET['bakes_and_cakes_admin_notice'] = '1' && wp_verify_nonce( $_GET['_wpnonce'], 'bakes_and_cakes_admin_notice' )) {
